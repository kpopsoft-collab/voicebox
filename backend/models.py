...
class GenerationRequest(BaseModel):
    ...
    engine: Optional[str] = Field(default="qwen", pattern="^(qwen|qwen_custom_voice|luxtts|chatterbox|chatterbox_turbo|tada|kokoro|melotts)$")
...
class MCPClientBindingResponse(BaseModel):
    ...
    default_engine: Optional[str] = Field(
        None,
        pattern="^(qwen|qwen_custom_voice|luxtts|chatterbox|chatterbox_turbo|tada|kokoro|melotts)$",
    )
